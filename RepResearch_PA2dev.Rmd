...
The NOAA Storm Database covers ~60 years of event impacts. Over that time, considerable changes have occurred, for example with regard to population distribution, building codes, regulations and development, zoning, and climate. Therefore we might expect to draw different conclusions from the data if only more recent data were reviewed. Figure 3 shows total health impacts for the same event types, but for the more recent time period 2000-2011. While "tornado" events continue to produce the greatest number of injuries, fatalities associated with "extreme heat" events have overtaken "tornados" as having the highest impact. This may be particularly important with regard to trend for more heatwave events forecast for high density urban areas as described in the [US National Climate Assessment Report 2014](nca2014.globalchange.gov).
